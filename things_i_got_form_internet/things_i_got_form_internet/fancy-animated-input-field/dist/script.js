function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}class Input {
...
class Keyboard {
  ...
  }}_defineProperty(Keyboard, "space", 32);_defineProperty(Keyboard, "backspace", 8);_defineProperty(Keyboard, "leftArrow", 37);_defineProperty(Keyboard, "rightArrow", 39);_defineProperty(Keyboard, "suppress", 46);_defineProperty(Keyboard, "top", 36);_defineProperty(Keyboard, "end", 35);
